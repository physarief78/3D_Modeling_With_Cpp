...
with open("fourier_series_animation_data.json", "r") as f:
    data = json.load(f)
...
initial_azim = 20    # Initial azimuth angle in degrees.
rotation_speed = 0.75   # Degrees to rotate per frame.
...
def update(frame_index):
    ...
    ax.set_title(f"Fourier Series of Spherical Eigenstates at Time: {frame['time']:.2f}")
...
ani.save("fourier_eigenstates_sphere_animation.gif", writer="pillow", fps=30)
